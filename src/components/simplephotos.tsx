...
const Photos = () => {
  return (
    <div className="pointer-events-none flex flex-col space-y-36 sm:space-y-80 w-full items-center photo-container">
      <div className="photo photo1 flex flex-col lg:flex-row ipad-pro:flex-col items-center gap-4 sm:gap-12 w-full bg-transparent">
        <Link
          href="/works/Guilty"
          className="relative w-[300px] sm:w-[500px] md:w-[400px] lg:w-[500px] h-[300px] sm:h-[500px] md:h-[400px] lg:h-[500px] transition-transform duration-500 hover:scale-105 pointer-events-auto"
        >
          <Image
      ...
      <div className="photo photo2 flex flex-col-reverse lg:flex-row ipad-pro:flex-col-reverse items-center gap-4 sm:gap-8 w-full  bg-transparent">
        ...
        <Link
          href="/works/DLEAGUE"
          className="relative w-[300px] sm:w-[500px] md:w-[400px] lg:w-[500px] h-[300px] sm:h-[500px] md:h-[400px] lg:h-[500px] transition-transform duration-500 hover:scale-105"
        >
          <Image
